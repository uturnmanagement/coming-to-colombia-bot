"""Hostelworld provider — STUB (reserved for a future phase).
...
class HostelworldProvider(LodgingProvider):
    name = "hostelworld"
    is_live = False
    ...
    def fetch_city(self, city: str) -> ProviderResult:
        return ProviderResult(
            ...
            reason="Hostelworld live wiring reserved for a later phase "
